...
export default function LandingPage({ user, theme, onToggleTheme, onSelectSection, onLogout, onOpenPomodoro }) {
  const now = useTime();
  ...
  return (
    <div className="landing-page">
      ...
      <div className="landing-content">
        {/* Left — Today + Sections + Activity */}
        <div className="landing-left">
          {/* Today summary at the top */}
          <TodayPanel onNavigateSection={onSelectSection} onOpenPomodoro={onOpenPomodoro} />

          <div className="landing-title" style={{ marginTop: 24 }}>What are we working on?</div>
      ...
      <div className="landing-bottom">
        <div className="landing-version">Kaseki v2.1.0 · Press <kbd>/</kbd> to search, <kbd>Shift+N</kbd> to capture, <kbd>?</kbd> for shortcuts</div>
